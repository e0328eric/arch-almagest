...
/* package battery-low-1.0.0.0 */
#ifndef VERSION_battery_low
#define VERSION_battery_low "1.0.0.0"
#endif /* VERSION_battery_low */
#ifndef MIN_VERSION_battery_low
#define MIN_VERSION_battery_low(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_battery_low */
...
#define CURRENT_COMPONENT_ID "battery-low-1.0.0.0-4I8FXZi5YnRGT14UXkKiDU-battery-low"
