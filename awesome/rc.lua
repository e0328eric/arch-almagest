...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"}, "c",
        ...
        {description = "open a trminal", group = "awesome"}),
    ...
    awful.key({ modkey, "Shift"}, "z",
        function ()
            awful.spawn("check-twice.sh \"Are you sure you want to suspend?\" \"systemctl suspend\"")
        end,
        {description = "open a trminal", group = "awesome"}),
    ...
    -- Menubar
    awful.key({ "Control", "Mod1" }, "s", function() menubar.show() end,
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "e", function (c) c:swap(awful.client.getmaster()) end,
