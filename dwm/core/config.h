...
/*static char* const autostart[][5] = {  please replace 2 with maximum number of arguments from autostart array
    { "picom", "-b", "--config", "$HOME/.config/compton/compton.conf", NULL },
    { "light-locker", NULL },
    { "nextcloud", NULL },
    { "battery-low", NULL },
...
static Key keys[] = {
    ...
    { MODKEY|ControlMask|ShiftMask, XK_Left,   setmfact,       {.f = -0.05} },
    { MODKEY|ControlMask|ShiftMask, XK_Right,  setmfact,       {.f = +0.05} },
