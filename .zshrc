...
export PATH="$PATH:/home/almagest/.gem/ruby/2.6.0/bin"
export PATH="$HOME/.cabal/bin:${GHCUP_INSTALL_BASE_PREFIX:=$HOME}/.ghcup/bin:$PATH"
export PATH="$PATH:/usr/local/texlive/2019/bin/x86_64-linux"
export PATH="/usr/local/anaconda/bin:$PATH"
export PATH="/home/linuxbrew/.linuxbrew/bin:$PATH"
export PATH="/usr/bin/unegg/release-x86:$PATH"
export VISUAL=vim
...
alias texsnip='sudo vim ~/.vim/localSnips/tex.snippets'
alias mdsnip='sudo vim ~/.vim/localSnips/markdown.snippets'
alias getmusic='youtube-dl -x --audio-format m4a'
alias gsync='cd ~/GDrive && grive'
alias coprime='vim /usr/local/texlive/texmf-local/tex/latex/local/coprime/coprime.cls'
...
alias cat="pygmentize -O full,style=gruvbox -g"
...
source /home/almagest/.config/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
